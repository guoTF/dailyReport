...
<form class="api-form" method="post"
	action="<%request.getContextPath();%>/xlr/form_6_2_FrontConsume"
	target="_blank">
	<p>
		<label>商户号：</label> <input id="merId" type="text" name="merId"
			placeholder="" value="898120073923877"
	...
	<p>
		<label>交易金额：</label> <input id="txnAmt" type="text" name="txnAmt"
			id='frontConsume' placeholder="交易金额" title="单位为分,不能带小数点 "
			required="required" />
	</p>
	<p>
	...
	<p>
		<label>商户订单号：</label> <input id="orderId" type="text" name="orderId"
			id='obtainId' placeholder="商户订单号" title="自行定义，8-32位数字字母 "
			required="required" />
	</p>
	<p>
