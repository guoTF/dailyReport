...
<body>
							...
							<fieldset>
								<div class="form-group">
									<input class="form-control" placeholder="用户名" name="userName"
										type="text" autofocus autocomplete="off" id="userName"
										onkeyup="this.value=this.value.replace(/[^\u4e00-\u9fa5a-zA-Z0-9\w]/g,'');">
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="登录密码" name="password"
										type="password" value="" autocomplete="off" id="password">
								</div>
								<div class="form-group login-validate">
									<input class="form-control" placeholder="验证码"
										name="identifyingCode" type="number" value=""
										id="identifyingCode"> <img
										src="${path}/common/getImgCode" alt="" id="validateImg">
								</div>
								<div class="checkbox">
	...
	<script type="text/javascript"
		src="${staticPath }/static/daily/login.js" charset="utf-8"></script>
</body>
</html>
