...
<body>
						...
						<form action="" id="serializeResiger" onsubmit="return false;">
							<fieldset>
								<div class="form-group login-validate">
									<label for="userNameResiger" class="">用户名:</label> <input
										class="form-control required" placeholder="用户名"
										name="userName" type="text" autofocus autocomplete="off"
										id="userNameResiger"
										onkeyup="this.value=this.value.replace(/[^\u4e00-\u9fa5a-zA-Z0-9\w]/g,'');">
								</div>

								<div class="form-group login-validate">
									<label for="passwordResiger" class="">登录密码:</label> <input
										class="form-control required" placeholder="登录密码"
										name="password" type="password" autocomplete="off"
										id="passwordResiger">
								</div>
								<div class="form-group login-validate">
									<label for="password2" class="">确认密码:</label> <input
										class="form-control required" placeholder="确认登录密码"
										name="password2" type="password" autocomplete="off"
										id="password2">
								</div>
								<div class="form-group login-validate">
									<label for="phoneNum" class="codeValidate">手机号码:</label> <input
										class="form-control required" placeholder="手机号码" type="text"
										name="phone" autocomplete="off" id="phoneNum">
								...
								<div class="form-group login-validate">
									<label for="mail" class="">有效邮箱:</label> <input
										class="form-control required" placeholder="有效邮箱" type="text"
								...
								<div class="form-group login-validate">
									...
									<select class="form-control" id="departmentId"
										name="department">
										<option>请选择</option>
									</select> <label for="post" class="posValidate">职位:&nbsp;&nbsp;</label>
								...
								<button id="submitResiger"
									class="btn btn-lg btn-success btn-block">注册</button>
								<!-- <div class="register">
				                    	还没有账户？<a href="#">立即注册</a>
				                    </div> -->
							</fieldset>
	...
	<script type="text/javascript"
		src="${staticPath }/static/daily/login.js?timestamp=<%=new Date().getTime()%>"
