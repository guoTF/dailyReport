...
; (function($) {
	...
	var methods = {
		...
		init: function(data, options) {
			var defaults = {
				center: true,locked: true,fixed: true,drag: true,zIndex: 9999,opacity: "0.6",title: "系统提示",staySame: false,isLoading : false,width: 0,height: 0,timer: 0,bgColor: "#000000",left: 350,top: 100,head: true,isClose: true,shake: false,blurClose: false,close: null,init: null
			};
